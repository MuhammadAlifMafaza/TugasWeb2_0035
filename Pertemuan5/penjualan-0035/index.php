...
// Initializing the ProdukController with the correct database connection
require_once 'app/controllers/ProdukController.php';
$controller = new ProdukController($dbConnection);
$controller->index(); // Calls the index function in ProdukController
